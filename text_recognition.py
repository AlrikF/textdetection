...
def fill_colour(image,startX,startY,endX,endY,cutpadding):
	...
	fill.append(image[startY + int(height*2// 4), startX])
	fill.append(image[startY + int(height*3// 4), startX])
	fill.append(image[startY , startX + (width // 4)])
	fill.append(image[startY, startX + (width*2//4)])
	fill.append(image[startY, startX + (width*3// 4)])
	fill.append(image[endY, startX])
	fill.append(image[endY, startX + (width // 4)])
	fill.append(image[endY, startX + (width*2 // 4)])
	fill.append(image[endY, startX + (width*3 // 4)])
	fill.append(image[startY, endX])
	fill.append(image[startY + (height//4), endX])
	fill.append(image[startY + int(height*2//4), endX])
...
mask=show_fill_color=orig.copy()

ret,mask=cv2.threshold(mask,0,0,cv2.THRESH_BINARY)
...
for ((startX, startY, endX, endY), text) in results:
	...
	show_fill_color=fill_colour(show_fill_color,startX,startY,endX,endY,0)
